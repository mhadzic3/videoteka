...
function validirajUnosKorisnika(boja, polje){
	var txtKorisnik=document.getElementById(polje);
...
function validirajUnosSifre(boja, polje){
	var txtSifra=document.getElementById(polje);
...
function provjeriSifru(polje1, polje2){
	var sifra1=document.getElementById(polje1).value;
	var sifra2=document.getElementById(polje2).value;
	
	var duzina1=sifra1.length;
	var duzina2=sifra2.length;
		
	if((duzina1>=duzina2 && sifra1.substr(0,duzina2)==sifra2) || sifra2==""){
		document.getElementById(polje2).style.backgroundColor="white";
	}
	else{
		document.getElementById(polje2).style.backgroundColor="red";
	}
}

function provjeriSifru2(sifra1, polje2){
	var sifra2=document.getElementById(polje2).value;
